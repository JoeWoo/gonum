...
func addRealQuat(r float64, q quat.Quat) quat.Quat {
	q.Real += r
	return q
}

func addQuatReal(q quat.Quat, r float64) quat.Quat {
	q.Real += r
	return q
}

func subRealQuat(r float64, q quat.Quat) quat.Quat {
	q.Real = r - q.Real
	return q
}

func subQuatReal(q quat.Quat, r float64) quat.Quat {
	q.Real -= r
	return q
}
